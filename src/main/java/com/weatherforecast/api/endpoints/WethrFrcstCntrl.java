...
@Api(tags = "Weather forecast", value = "Performs CRUD operations on the patient.")
public class WethrFrcstCntrl {
	...
	@GetMapping("/v1/data/{cityName}/{countryCode}")
	...
	public ResponseEntity<WeatherForecastResp> fetchWethrFrecstParams(@PathVariable("cityName") final String cityNm,@PathVariable("countryCode") final String cntryCd) throws  WeatherForecastException, DataNotFoundException, IOException, UnauthorisedException {
